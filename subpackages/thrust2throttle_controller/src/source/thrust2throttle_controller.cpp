...
void Thrust2throttleController::computeThrottle(){
	...
	std::cout << "throttle 1 : " << throttle << std::endl;
	...
	std::cout << "throttle 2 : " << throttle << std::endl;
